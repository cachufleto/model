...
- Instead of one monolithic stylesheet, ifocop sub-themes' CSS files are organized
...
- layouts/responsive.css:
  ifocop's default layout is based on the ifocop Grids layout method. Despite the
  name, it is an independent project from the ifocop theme. ifocop Grids is an
  ...
  learn more about ifocop Grids at http://ifocopgrids.com
...
- layouts/fixed.css:
  This layout is based on the ifocop Grids layout method, but uses a fixed pixel
...
- components/misc.css:
  ...
  - Tabs: contains actual styling for Drupal tabs, a common Drupal element that
    is often neglected by site designers. ifocop provides some basic styling which
...
check ifocop's online documentation: https://drupal.org/node/1707736


STYLES FOR INTERNET EXPLORER
----------------------------

ifocop allows IE-specific styles using a method first described by Paul Irish at:
http://paulirish.com/2008/conditional-stylesheets-vs-css-hacks-answer-neither/

If you look at ifocop's templates/html.tpl.php file, you will see the HTML tag that
...
Note: Many of ifocop's styles are overriding Drupal's core stylesheets, so if you
