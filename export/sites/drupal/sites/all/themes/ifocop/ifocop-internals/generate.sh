...
# files and make copies of the STARTERKIT stylesheets for the base ifocop theme.
...
# Build the stylesheets for the ifocop base theme.
...
# Copy the stylesheets from STARTERKIT to the ifocop theme.
rm $ORIG/css/*.css;
rm $ORIG/images/*;
