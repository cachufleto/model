...
INSERT INTO `agence` (`num_agence`, `nom`, `adresse`) VALUES
...
CREATE TABLE `annonce_bien` (
  `ref_bien` int(4) NOT NULL,
  `type` varchar(100) NOT NULL,
  `ville` varchar(100) NOT NULL,
  `prix` int(7) NOT NULL,
  `superficie` int(5) NOT NULL,
  `categorie` varchar(100) NOT NULL,
  PRIMARY KEY  (`ref_bien`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO `annonce_bien` (`ref_bien`, `type`, `ville`, `prix`, `superficie`, `categorie`) VALUES
...
CREATE TABLE `association_bien_agence` (
  `id_association_bien_agence` int(5) NOT NULL auto_increment,
  `num_agence` int(6) NOT NULL,
  `ref_bien` int(4) NOT NULL,
  `frais` int(7) NOT NULL,
  PRIMARY KEY  (`id_association_bien_agence`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=52 ;


INSERT INTO `association_bien_agence` (`id_association_bien_agence`, `num_agence`, `ref_bien`, `frais`) VALUES
(1, 257400, 5067, 15000),
(2, 383505, 5067, 1000),
(3, 257400, 5089, 8633),
(4, 692702, 5089, 7623),
...
CREATE TABLE `association_bien_personne` (
  `id_association_bien_personne` int(5) NOT NULL auto_increment,
  `id_personne` int(3) NOT NULL,
  `ref_bien` int(4) NOT NULL,
  PRIMARY KEY  (`id_association_bien_personne`),
  UNIQUE KEY `ref_bien` (`ref_bien`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=28 ;


INSERT INTO `association_bien_personne` (`id_association_bien_personne`, `id_personne`, `ref_bien`) VALUES
(1, 40, 5067),
(2, 41, 5089),
(3, 42, 5091),
(4, 2, 5122),
...
CREATE TABLE `demande_achat` (
  `id_demande_achat` int(5) NOT NULL auto_increment,
  `id_personne` int(3) NOT NULL,
  `type` varchar(100) NOT NULL,
  `ville` varchar(100) NOT NULL,
...
INSERT INTO `demande_achat` (`id_demande_achat`, `id_personne`, `type`, `ville`, `budget`, `superficie`, `categorie`) VALUES
