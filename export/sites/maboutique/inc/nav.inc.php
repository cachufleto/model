<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo RACINE_SITE; ?>index.php">MaBoutique</a>
        </div>
...
?>
			<li><a class="navbar-brand" style="color:red" href="<?php echo RACINE_SITE; ?>inc/rss.php">RSS</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
