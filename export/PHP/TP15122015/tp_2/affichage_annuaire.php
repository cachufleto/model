...
{
	$id = $_GET['id_annuaire'];
	$Repertoire->query("DELETE FROM annuaire WHERE id_annuaire=$id");
}
...
echo '<table border="1" style="border-collapse:collapse;">';
	...
	while ($ligne = $resultat1->fetch_assoc()) {
		...
		echo '<td><a href="formulaire.php?action=modification&id_annuaire='.$ligne['id_annuaire'].'">---</a></td><td><a href="?action=suppression&id_annuaire='.$ligne['id_annuaire'].'">X</a></td></tr>';
		# code...
	}
echo '</table>';
