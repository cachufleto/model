...
they download the ifocop theme is that there are A LOT of files -- way more than
other themes.

Don't worry! You don't need to learn everything all at once in order to make a
Drupal theme. ifocop will do the bits you haven't learned and patiently wait for
...
So how do you create a theme with ifocop?

The ifocop theme includes the ifocop base theme as well as a starter theme called
"STARTERKIT". You shouldn't modify any of the CSS or PHP files in the ifocop/
folder; but instead you should create a sub-theme of ifocop and put it in a folder
outside of the root ifocop/ folder.
...
Full documentation on the ifocop theme can be found in Drupal's Handbook:
...
------------
 ...
 1. Download ifocop from https://drupal.org/project/ifocop

 2. Unpack the downloaded file, take the entire ifocop folder and place it in your
 ...
 3. Log in as an administrator on your Drupal site and go to the Appearance page
    at admin/appearance. You will see the ifocop theme listed under the Disabled
    Themes heading with links on how to create your own sub-theme. You can
    optionally make ifocop the default theme.
