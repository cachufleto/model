...
The ifocop theme overrides a handful of Drupal's templates. In order to override
those templates, you should copy them from the ifocop/templates folder to your
...
Located in /modules/block:
  block.tpl.php  (overridden by ifocop)
...
Located in /modules/comment:
  comment-wrapper.tpl.php  (overridden by ifocop)
  comment.tpl.php  (overridden by ifocop)
...
Located in /modules/node:
  node.tpl.php  (overridden by ifocop)
...
Located in /modules/system:
  html.tpl.php  (overridden by ifocop)
  maintenance-page.tpl.php  (overridden by ifocop)
  page.tpl.php  (overridden by ifocop)
  region.tpl.php  (overridden by ifocop)
...
Located in /modules/user:
  user-picture.tpl.php  (overridden by ifocop)
