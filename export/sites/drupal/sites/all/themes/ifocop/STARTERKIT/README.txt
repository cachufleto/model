BUILD A THEME WITH ifocop
----------------------

The base ifocop theme is designed to be easily extended by its sub-themes. You
shouldn't modify any of the CSS or PHP files in the ifocop/ folder; but instead you
should create a sub-theme of ifocop which is located in a folder outside of the
root ifocop/ folder. The examples below assume ifocop and your sub-theme will be
...
(read the sites/default/default.settings.php for more info.)
  ...
  Why? To learn why you shouldn't modify any of the files in the ifocop/ folder,
...
*
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the STARTERKIT folder out of the ifocop/ folder and rename it to be your
    ...
    For example, copy the sites/all/themes/ifocop/STARTERKIT folder and rename it
    as sites/all/themes/foo.

      Why? Each theme should reside in its own folder. To make it easier to
      upgrade ifocop, sub-themes should reside in a folder separate from the base
      theme.
 ...
 2. Setup the basic information for your sub-theme.
    ...
    foo.info file and change "name = ifocop Sub-theme Starter Kit" to "name = Foo"
    and "description = Read..." to "description = A ifocop sub-theme".
...
Optional steps:
 ...
 6. Modify the markup in ifocop core's template files.

    If you decide you want to modify any of the .tpl.php template files in the
    ifocop folder, copy them to your sub-theme's folder before making any changes.
    And then rebuild the theme registry.

    For example, copy ifocop/templates/page.tpl.php to foo/templates/page.tpl.php.
 ...
 8. Further extend your sub-theme.
    ...
    Discover further ways to extend your sub-theme by reading ifocop's
